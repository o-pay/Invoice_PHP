...
if (isset($VAR_POST['Invoice_Method']))
{
	...
	{
		case 'INVOICE':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Invoice/Issue' ;
		break;
		case 'INVOICE_DELAY':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Invoice/DelayIssue' ;
		break;
		case 'ALLOWANCE':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Invoice/Allowance' ;
		break;
		case 'INVOICE_VOID':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Invoice/IssueInvalid' ;
		break;
		case 'ALLOWANCE_VOID':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Invoice/AllowanceInvalid' ;
		break;
		case 'INVOICE_SEARCH':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Query/Issue' ;
		break;
		case 'INVOICE_VOID_SEARCH':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Query/IssueInvalid' ;
		break;
		case 'ALLOWANCE_SEARCH':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Query/Allowance' ;
		break;
		case 'ALLOWANCE_VOID_SEARCH':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Query/AllowanceInvalid' ;
		break;
		case 'INVOICE_NOTIFY':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Notify/InvoiceNotify' ;
		break;
		case 'INVOICE_TRIGGER':
	        	$Invoice_Url = 'https://einvoice-stage.opay.tw/Invoice/TriggerIssue' ;
		break;
	}
...
{	
	...
	if(select_invoice == 'INVOICE')
	{
		...
		document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Invoice/Issue";
	}
	...
	if(select_invoice == 'INVOICE_DELAY')
	{
		...
		document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Invoice/DelayIssue";
	}
	...
	if(select_invoice == 'ALLOWANCE')
	{
		...
		document.getElementById( "49" ).className = "td-mark";
		document.getElementById( "143" ).className = "td-mark";
		document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Invoice/Allowance";
	}
	...
	if(select_invoice == 'INVOICE_VOID')
	{
		...
		document.getElementById( "49" ).className = "td-mark";
		document.getElementById( "143" ).className = "td-mark";
		document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Invoice/IssueInvalid";
	}
	...
	if(select_invoice == 'ALLOWANCE_VOID')
	{
		...
		document.getElementById( "49" ).className = "td-mark";
		document.getElementById( "143" ).className = "td-mark";
		document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Invoice/AllowanceInvalid";
	}
	...
	if(select_invoice == 'INVOICE_SEARCH' || select_invoice == 'INVOICE_VOID_SEARCH')
	{
		...
		{
			document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Query/Issue";
		}
		else
		{
			document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Query/IssueInvalid";
		}
	}
	...
	if(select_invoice == 'ALLOWANCE_SEARCH' || select_invoice == 'ALLOWANCE_VOID_SEARCH')
	{
		...
		{
			document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Query/Allowance";
		}
		else
		{
			document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Query/AllowanceInvalid";
		}
	}
	...
	if(select_invoice == 'INVOICE_NOTIFY')
	{
		...
		document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Notify/InvoiceNotify";
	}
	...
	if(select_invoice == 'INVOICE_TRIGGER')
	{
		...
		document.getElementById("invoice_url").innerHTML = "https://einvoice-stage.opay.tw/Invoice/TriggerIssue";
	}
